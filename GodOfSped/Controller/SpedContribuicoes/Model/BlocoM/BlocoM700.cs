...
public class BlocoM700
{
    public String REG { get; } = "M700";
    ...
    {
        String ret = $"|{REG}|{COD_CONT}|{VL_CONT_APUR_DIFER}|{NAT_CRED_DESC}|{VL_CRED_DESC_DIFER}|{VL_CONT_DIFER_ANT}|{PER_APUR}|{DT_RECEB}|";
