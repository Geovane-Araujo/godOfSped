...
public class Bloco1100
{
    ...
    {
        String ret =
            $"|{REG}|{PER_APU_CRED}|{ORIG_CRED}|{CNPJ_SUC}|{COD_CRED}|{VL_CRED_APU}|{VL_CRED_EXT_APU}|{VL_TOT_CRED_APU}|{VL_CRED_DESC_PA_ANT}|" +
            $"{VL_CRED_PER_PA_ANT}|{VL_CRED_DCOMP_PA_ANT}|{SD_CRED_DISP_EFD}|{VL_CRED_DESC_EFD}|{VL_CRED_PER_EFD}|{VL_CRED_DCOMP_EFD}|" +
